...
export default function Terms() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        title="Terms & Conditions | SaniLady"
        description="Terms and conditions for SaniLady feminine hygiene and sanitary waste management services."
        canonical="/terms"
        noindex={true}
      />
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
          ...
          <p>
            ...
            hygiene products. Eligibility, enrollment, and participation terms are subject to the agreement
            between SaniLady and the employing organization.
          </p>
          <h3>2.2 Sanitary Waste Management</h3>
          <p>
            We provide sanitary bin supply, collection, and disposal services in accordance with UK environmental
          ...
          <ul>
            ...
            <li>Service frequency and schedules</li>
            <li>Contract duration and termination provisions</li>
          ...
          <p>
            Invoices are issued monthly and payment is due within 30 days unless otherwise agreed. Late payments
            may incur interest charges as permitted by law.
          </p>
          <h3>4.3 Taxes</h3>
          <p>
          ...
          <p>
            ...
            adjust schedules due to circumstances beyond our control.
          </p>
          <h3>5.2 Access Requirements</h3>
          <p>
            Clients must provide reasonable access to service locations during agreed service times.
          </p>
          <h3>5.3 Service Suspension</h3>
          <p>
            We reserve the right to suspend services for non-payment or breach of terms after providing
            reasonable notice.
          </p>
          ...
          <ul>
            ...
            <li>Ensure reasonable access for service delivery</li>
            <li>Use supplied equipment appropriately</li>
          ...
          <p>
            Our liability is limited to the fees paid for the specific service in question, except where
            liability cannot be excluded or limited by law.
          </p>
          ...
          <h3>10.2 By SaniLady</h3>
          <p>
            We may terminate services immediately for material breach, with written notice for convenience, or
            with 30 days' notice without cause.
          </p>
          <h3>10.3 Effect of Termination</h3>
          <p>
            Upon termination, all outstanding fees become immediately due. Supplied equipment remains our
