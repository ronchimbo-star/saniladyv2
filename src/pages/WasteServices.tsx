  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6">
              ...
              <h3 className="font-bold text-gray-800 mb-2">Corporate Offices</h3>
              <p className="text-gray-600">Professional workplace solutions for businesses of all sizes</p>
            </div>

            <div className="text-center p-6">
              <div className="text-5xl mb-3">🏥</div>
              <h3 className="font-bold text-gray-800 mb-2">Healthcare Facilities</h3>
              <p className="text-gray-600">Specialized service for medical practices and care homes</p>
            </div>

            <div className="text-center p-6">
              <div className="text-5xl mb-3">🏫</div>
              <h3 className="font-bold text-gray-800 mb-2">Educational Institutions</h3>
              <p className="text-gray-600">Schools, colleges, and universities across our service area</p>
            </div>

            <div className="text-center p-6">
              <div className="text-5xl mb-3">��</div>
              <h3 className="font-bold text-gray-800 mb-2">Retail & Hospitality</h3>
              <p className="text-gray-600">Shops, restaurants, hotels, and public-facing venues</p>
            </div>

            <div className="text-center p-6">
              <div className="text-5xl mb-3">🏋️</div>
              <h3 className="font-bold text-gray-800 mb-2">Leisure Facilities</h3>
              <p className="text-gray-600">Gyms, sports centers, and recreational facilities</p>
            </div>

            <div className="text-center p-6">
              <div className="text-5xl mb-3">🏭</div>
              <h3 className="font-bold text-gray-800 mb-2">Manufacturing</h3>
              <p className="text-gray-600">Industrial sites and warehouses with employee facilities</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl p-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">
            Get a Free Waste Management Assessment
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Not sure what you need? We'll visit your site and provide a free assessment with customized
            recommendations
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="bg-gradient-to-r from-blue-600 to-teal-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-lg transform hover:scale-105 transition-all"
            >
              Request a Quote
            </Link>
            <Link
              to="/contact"
              className="bg-white text-blue-600 border-2 border-blue-600 px-8 py-4 rounded-full font-bold text-lg hover:shadow-lg transform hover:scale-105 transition-all"
            >
              Schedule Assessment
            </Link>
          </div>
